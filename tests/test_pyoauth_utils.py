...
class TestOauthParseAuthHeader:
    def test_oauth_parse_auth_header(self):
        # assert_equal(expected, oauth_parse_auth_header(header_value))
        expected_value = {
            'realm': ['Examp%20le'],
        ...
        assert_equal(expected_value, oauth_parse_auth_header('''
            OAuth
