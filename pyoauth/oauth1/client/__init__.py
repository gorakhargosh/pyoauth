...
class Client(object):
    ...
    def _build_request(self,
        ...
        :param headers:
            ...
            If the "Authorization" header is included, its value will be set
            to the authorization header value generated by this function.
        :param realm:
        ...
        for k, v in extra_oauth_params.items():
            if k in ("oauth_signature",
                     ...
                     "oauth_timestamp",
                     "oauth_consumer_key",
                     "oauth_version",       # If specified, MUST be set to "1.0", which is what our class does.
                    ):
