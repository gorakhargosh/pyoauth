...
class _OAuthClient(object):
    ...
    @classmethod
    def generate_signature(cls, method, url, params,
        ...
        :param oauth_params:
            ...
            :func:`OAuthClient.generate_oauth_params`.
        :returns:
            Request signature.
        """
    ...
    @classmethod
    def build_request(cls, method, url, params, body, headers,
...
class Client(_OAuthClient):
    ...
    def fetch_temporary_credentials(self,
        ...
        return self.fetch(method, url, params,
                          body, headers,
    ...
    def fetch_token_credentials(self,
        ...
        response = self.fetch(method, url, params,
                         body, headers,
                         async_callback=async_callback,
                         realm=realm,
